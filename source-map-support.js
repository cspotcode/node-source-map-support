...
function mapSourcePosition(position) {
  ...
  if (sourceMap && sourceMap.map && typeof sourceMap.map.findEntry === 'function') {
    var originalPosition = sourceMap.map.findEntry(position.line - 1, position.column);
